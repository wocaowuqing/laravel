                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('wheel/add')}}">图片添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('wheel/index')}}">图片列表</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('team/add')}}">球队添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('team/index')}}">球队列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('player/index')}}">球员列表</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('match/add')}}">比赛添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('match/index')}}">比赛列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('data/index')}}">详情数据</a>
                            </li>
                        </ul>
                    </li>
<!-- 
                    <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">球员比赛数据</span>
                            <span class="fa arrow"></span>
                        </a>

                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('data/add')}}">比赛数据添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('data/index')}}">比赛数据列表</a>
                            </li>
                        </ul>
                    </li> -->
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">文字直播</span>
                            <span class="fa arrow"></span>
                        </a>

                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('good/add')}}">文字添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('good/index')}}">直播列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('good/create')}}">文字添加</a>
                            </li>
                        </ul>
                    </li>
                </ul>
